...

{
  // Objects of Question Class
    ...
    q11.setValues("11.If Dhaka to Chittagong=400 km, Chittagong to Dhaka=400 km  then Saturday to Friday=6 days,Friday to Saturday=?", "6","7", "1","400", 3, 10);
    q12.setValues("12.A clock shows 2pm.Through how many degrees has the hour hand rotated when the clock is showing 7:30 pm?"
    ...
    q14.setValues("14.Akhi,who is sixteen years old,is four times as old as her brother.How old will Akhi be when she is twice as old as her brother? ",
                  "20","24", "25","26", 2, 10);
    q15.setValues("15.If takes 3 people 18 minutes to decorate 15 cupcakes.How many cupcakes can 6 people complete within an hour?"
                  , "60","75", "90","100", 4, 10);
...
// If the player pass the quiz
  ...
  // Objects of Question Class
    ...
    q32.setValues("17.How much is half of 2+2", "1+1","2", "3","None", 3, 10);
    ...
    q35.setValues("20.A shepherd has 18 goats.All but 6 die.How many are left?", "18","6", "12","24", 2, 10);
